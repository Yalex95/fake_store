...
async function main() {
  // Main Categories
    const man = await prisma.categories.upsert({
    where: { slug: "man" },
    update: {},
    create: { name: "Man", slug: "man" },
  });

  const woman = await prisma.categories.upsert({
    where: { slug: "woman" },
    update: {},
    create: { name: "Woman", slug: "woman" },
  });

  const kids = await prisma.categories.upsert({
    where: { slug: "kids" },
    update: {},
    create: { name: "Kids", slug: "kids" },
  });

  const sports = await prisma.categories.upsert({
    where: { slug: "sports" },
    update: {},
